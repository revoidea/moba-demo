<template>
  <div class="page-hero">
    ...
    <div class="top" v-if="model" :style="{'background-image':`url(${model.banner})`}"> 
      <!--jc-end:会失灵-->
       <div class="info text-white p-3 h-100 d-flex flex-column jc-center">
      ...
      <swiper>
        <swiper-slide>
          <div>
            ...
            <m-card plain icon="cc-menu-circle" title="对战技巧">
...
.page-hero {
  ...
  .info {
    background: linear-gradient(rgba(0,0,0,0),rgba(0,0,0,1));//背景颜色渐变
    .scores {
      .badge{
        margin: 0 0.25rem;
